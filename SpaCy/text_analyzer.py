...
class TextAnalyzer:
    def __init__(self):
        """Initialize the TextAnalyzer with required models and components"""
        self.ensure_model_downloaded()
        # Create spaCy model with necessary components for lemmatization
        self.nlp = spacy.load("en_core_web_sm", disable=["ner", "parser", "matcher"])
    ...
    def analyze_text(self, text, save_path=None):
        """Perform full text analysis: preprocessing and classification"""
        # Preprocess text
        ...
        if save_path:
            self.save_results(save_path, preprocessing_results, classification_results)
            
        return preprocessing_results, classification_results

    def save_results(self, output_file, preprocessing_results, classification_results=None):
...
def main():
    ...
    if text_data:
        ...
        preprocessing_results, classification_results = analyzer.analyze_text(
            text_data, 
            save_path='analysis_results.txt'
        )
